...
namespace MultiShop.WebUI.Services.Concrete
{
    public class IdentityService : IIdentityService // Token alır bu class
    {
        ...
        private readonly HttpClient _httpClient; //API sorğuları göndərmək üçün.
        private readonly IHttpContextAccessor _httpContextAccessor; //Mövcud HTTP sorğusuna çıxış əldə etmək üçün.
        private readonly ClientSettings _clientSettings; //appsettings.json-dan IdentityServer parametrlərini oxuyur.
